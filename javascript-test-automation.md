...
* [Coveralls GitHub Action](https://github.com/marketplace/actions/coveralls-action) - A GitHub Action that will automatically report your latest test results to coveralls
