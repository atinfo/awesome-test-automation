...
- [General purpose test automation tools](#general-purpose-test-automation-tools)
...
## Functional testing
* [Concordia](http://concordialang.org) Generate functional tests automatically from your Agile specification. Open source, framework-independent, multi-platform testing without coding.
