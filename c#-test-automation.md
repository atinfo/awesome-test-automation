...
* [testmail.app](https://testmail.app) - Automate end-to-end email tests with unlimited mailboxes and a GraphQL API; works with any GraphQL client (e.g. [GraphQL.Client](https://github.com/graphql-dotnet/graphql-client))
