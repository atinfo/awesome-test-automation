...
* <a href='http://relevantcodes.com/extentreports-for-selenium/'>ExtentReports</a> - HTML reporting library for .NET and Java which is extremely easy to use and creates beautiful execution reports. It shows test and step summary, test steps and status in a toggle view for quick analysis.
